...
function IconScan({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="12" cy="12" r="3" /><path d="M12 7v1" /><path d="M12 16v1" />
      <path d="M7 12h1" /><path d="M16 12h1" />
    </svg>
  );
}
...
function IconWifi({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <line x1="2" x2="22" y1="2" y2="22" /><path d="M8.5 16.5a5 5 0 0 1 7 0" />
      <path d="M2 8.82a15 15 0 0 1 4.17-2.65" /><path d="M10.66 5c4.01-.36 8.14.9 11.34 3.76" />
      <path d="M16.85 11.25a10 10 0 0 1 2.22 1.68" /><path d="M5 12.86a10 10 0 0 1 5.17-2.89" />
    ...
    <div className="border-b border-[rgba(255,107,0,0.15)] bg-[rgba(255,107,0,0.04)]">
      <div className="mx-auto flex max-w-6xl items-center justify-center gap-3 px-6 py-2.5">
        ...
        <span className="text-[13px] text-[oklch(0.6_0_0)]">
          <span className="font-semibold text-white">v0.1.0 is live</span>
          {" "}&mdash; LoopStorm Guard is now open source.{" "}
          <a
    ...
    <nav className="sticky top-0 z-50 border-b border-[rgba(255,255,255,0.06)] bg-[rgba(10,10,10,0.7)] backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-6 text-sm md:flex">
          <a href="#terminal" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            See It Work
          </a>
          <a href="#stages" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            How It Works
          </a>
          <a href="#features" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            Features
          </a>
          <a href="#code" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            Quick Start
          </a>
          <a href="#pricing" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            Pricing
          </a>
          <a href="#faq" className="text-[oklch(0.5_0_0)] transition-colors duration-300 hover:text-white no-underline">
            FAQ
          </a>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          ...
          style={{ background: "var(--color-accent-amber)", animation: "float-slow 12s ease-in-out infinite" }}
        />
        <div
          className="absolute right-1/4 top-1/3 h-[300px] w-[300px] rounded-full opacity-15 blur-[80px]"
          style={{ background: "var(--color-accent-purple)", animation: "float-reverse 15s ease-in-out infinite" }}
        />
        <div
          className="absolute bottom-1/4 left-1/2 h-[250px] w-[250px] -translate-x-1/2 rounded-full opacity-10 blur-[80px]"
          style={{ background: "var(--color-accent-red)", animation: "float-slow 18s ease-in-out infinite 3s" }}
        />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-16 pt-24 md:pb-24 md:pt-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mb-6 text-5xl font-extrabold leading-[1.08] tracking-tight text-white md:text-7xl lg:text-8xl">
            Runtime Guardrails{" "}
            <span className="bg-gradient-to-r from-[var(--color-accent-amber)] via-[#ffaa44] to-[var(--color-accent-amber)] bg-[length:200%_auto] bg-clip-text text-transparent" style={{ animation: "gradient-x 4s ease infinite" }}>
              for AI Agents
            </span>
          </h1>
          ...
          <p className="mx-auto mb-12 max-w-2xl text-lg leading-relaxed text-[oklch(0.5_0_0)] md:text-xl">
            Intercept every tool call. Enforce policies. Cap budgets. Detect loops.
            Write tamper-evident audit logs.{" "}
            <span className="font-medium text-[oklch(0.75_0_0)]">All before your agent touches production.</span>
          </p>
...
const integrations = [
  ...
  "CrewAI", "AutoGen", "Google Gemini", "Mistral",
];
        ...
        <ScrollReveal>
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-lg text-base leading-relaxed text-[oklch(0.5_0_0)]">
              Every tool call is evaluated against your policy. Allowed, denied, or killed &mdash; with a full audit trail.
            </p>
          </div>
        </ScrollReveal>
...
const stages = [
  { num: 1, name: "Prevent", type: "Deterministic", icon: IconShield, color: "var(--color-accent-amber)", description: "Policy enforcement at the call boundary.", detail: "Binary allow or deny. First-match-wins rule evaluation. YAML-defined. P99 < 1ms latency." },
  { num: 2, name: "Detect", type: "Deterministic", icon: IconScan, color: "var(--color-accent-amber)", description: "Loop-detection heuristics within a run.", detail: "Same call fingerprint? Error loops? Stuck retry cycles? Detected immediately — no ML required." },
  { num: 3, name: "Recover", type: "Deterministic", icon: IconRefresh, color: "var(--color-accent-amber)", description: "Cooldown + corrective context injection.", detail: "One structured chance for the agent to self-correct. Bounded: if it fails, escalation is automatic." },
  { num: 4, name: "Contain", type: "Deterministic", icon: IconLock, color: "var(--color-accent-amber)", description: "Safe termination with evidence preservation.", detail: "Clean shutdown, not a process kill. Audit log sealed. Evidence preserved for human review." },
  { num: 5, name: "Adapt", type: "AI-Assisted", icon: IconBrain, color: "var(--color-supervisor)", description: "AI Supervisor on the observation plane.", detail: "Interprets patterns. Proposes policy updates. Escalates to humans. Never in the enforcement critical path.", isAdvisory: true },
] as const;
      ...
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-lg text-base leading-relaxed text-[oklch(0.5_0_0)]">
              Stages 1 &ndash; 4 are fully deterministic. No AI in the critical path.
              Stage 5 is advisory only &mdash; human approval required.
            </p>
          </div>
        </ScrollReveal>

        <div className="relative">
          <div className="absolute left-8 top-0 hidden h-full w-px lg:block" style={{ background: "linear-gradient(to bottom, var(--color-accent-amber), var(--color-border) 60%, var(--color-supervisor))" }} />
              ...
              return (
                <ScrollReveal key={stage.num} delay={i * 100}>
                  <div className="group relative lg:pl-20 lg:py-6">
                    <div className="absolute left-6 top-8 z-10 hidden h-5 w-5 items-center justify-center rounded-full border-2 lg:flex" style={{ borderColor: stage.color, backgroundColor: "var(--color-bg)", boxShadow: `0 0 12px ${stage.color}33` }}>
                      <div className="h-2 w-2 rounded-full" style={{ backgroundColor: stage.color }} />
                    </div>
                    <div className={`card-glow rounded-xl border p-6 transition-all duration-300 md:p-8 ${isAI ? "border-[var(--color-supervisor-border)] bg-[var(--color-supervisor-bg)]" : "border-[var(--color-border)] bg-[rgba(17,17,17,0.5)] hover:bg-[rgba(17,17,17,0.8)]"}`}>
                      <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-6">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border transition-all duration-300 group-hover:scale-110" style={{ borderColor: isAI ? "var(--color-supervisor-border)" : "var(--color-border)", backgroundColor: isAI ? "rgba(196,169,107,0.08)" : "var(--color-bg)", boxShadow: `0 0 20px ${stage.color}11` }}>
                          <Icon className="h-5 w-5" style={{ color: stage.color }} />
                        </div>
                        <div className="flex-1">
                          <div className="mb-2 flex flex-wrap items-center gap-3">
                            <span className="font-[family-name:var(--font-mono)] text-[11px] font-semibold uppercase tracking-wider" style={{ color: stage.color }}>Stage {stage.num}</span>
                            <span className="rounded-full bg-[var(--color-bg)] px-2.5 py-0.5 font-[family-name:var(--font-mono)] text-[10px] text-[oklch(0.45_0_0)] ring-1 ring-[var(--color-border)]">{stage.type}</span>
                          </div>
                          <h3 className={`mb-1.5 text-lg font-bold ${isAI ? "italic" : ""}`} style={{ color: isAI ? "var(--color-supervisor)" : "oklch(0.92 0 0)" }}>{stage.name}</h3>
                          <p className="mb-2 text-sm" style={{ color: isAI ? "var(--color-supervisor)" : "oklch(0.65 0 0)" }}>{stage.description}</p>
                          <p className="text-sm leading-relaxed text-[oklch(0.45_0_0)]">{stage.detail}</p>
                          {isAI && <p className="mt-3 font-[family-name:var(--font-mono)] text-xs italic text-[var(--color-supervisor)]">Advisory only &middot; Human approval required &middot; Self-guarded</p>}
                        </div>
                      </div>
                    </div>
                  </div>
...
const features = [
  { icon: IconFileCode, title: "Policy Rules", description: "YAML-defined rules. Deny cloud metadata, block unauthorized tools, restrict URLs. First match wins." },
  { icon: IconTerminal, title: "Budget Caps", description: "Hard limits on cost (USD), tokens, and call count per run. Fail-closed when exceeded." },
  { icon: IconScan, title: "Loop Detection", description: "Fingerprint-based heuristics catch retry loops, error loops, and stuck agents automatically." },
  { icon: IconHash, title: "Hash-Chain Audit Log", description: "Tamper-evident JSONL log with SHA-256 hash chain. CLI-verifiable. Any tampering is detectable." },
  { icon: IconWifi, title: "Mode 0 — Air-Gapped", description: "Runs entirely local. No account. No network. No telemetry. pip install and go." },
  { icon: IconCode, title: "Open Core", description: "Engine + CLI + shims are MIT. Use them anywhere. Control plane UI is AGPL-3.0." },
];
  ...
  return (
    <section id="features" className="border-t border-[var(--color-border)] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-widest text-[var(--color-accent-amber)]">Capabilities</p>
            <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Everything You Need</h2>
            <p className="mx-auto max-w-lg text-base leading-relaxed text-[oklch(0.5_0_0)]">A complete safety layer between your AI agents and production systems.</p>
          </div>
        </ScrollReveal>
            ...
            return (
              <ScrollReveal key={feature.title} delay={i * 80}>
                <div className="card-glow group h-full rounded-xl border border-[var(--color-border)] bg-[rgba(17,17,17,0.5)] p-6 transition-all duration-300 hover:bg-[rgba(17,17,17,0.8)]">
                  ...
                  <h3 className="mb-2 text-[15px] font-semibold text-[oklch(0.9_0_0)]">{feature.title}</h3>
                  <p className="text-sm leading-relaxed text-[oklch(0.5_0_0)]">{feature.description}</p>
                </div>
              </ScrollReveal>
            );
          })}
  ...
  return (
    <section id="code" className="border-t border-[var(--color-border)] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-widest text-[var(--color-accent-amber)]">Quick Start</p>
            <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Integrate in Under 2 Minutes</h2>
            <p className="mx-auto max-w-lg text-base leading-relaxed text-[oklch(0.5_0_0)]">Add LoopStorm Guard to your agent in Python or TypeScript. Define your policy in YAML.</p>
          </div>
        </ScrollReveal>

        <div className="grid gap-5 lg:grid-cols-3">
          <ScrollReveal delay={0}><CodeBlock filename="agent.py" lang="Python" code={pythonCode} /></ScrollReveal>
          <ScrollReveal delay={100}><CodeBlock filename="agent.ts" lang="TypeScript" code={tsCode} /></ScrollReveal>
          <ScrollReveal delay={200}><CodeBlock filename="loopstorm.yaml" lang="Policy" code={yamlCode} /></ScrollReveal>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <div className="card-glow h-full overflow-hidden rounded-xl border border-[var(--color-border)] bg-[#080808]">
      <div className="flex items-center justify-between border-b border-[var(--color-border)] px-4 py-3">
        <span className="font-[family-name:var(--font-mono)] text-[11px] text-[oklch(0.45_0_0)]">{filename}</span>
        <span className="rounded-full bg-[var(--color-bg)] px-2.5 py-0.5 font-[family-name:var(--font-mono)] text-[10px] text-[oklch(0.4_0_0)] ring-1 ring-[var(--color-border)]">{lang}</span>
      </div>
      <pre className="overflow-x-auto p-5">
        <code className="font-[family-name:var(--font-mono)] text-[13px] leading-relaxed text-[oklch(0.65_0_0)]">{code}</code>
      </pre>
    </div>
  );
}
  ...
  return (
    <section id="pricing" className="border-t border-[var(--color-border)] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-widest text-[var(--color-accent-amber)]">Pricing</p>
            <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Free to Start. Built to Scale.</h2>
            <p className="mx-auto max-w-lg text-base leading-relaxed text-[oklch(0.5_0_0)]">
        ...
        <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-3">
          ...
          <ScrollReveal delay={0}>
            <div className="card-glow flex h-full flex-col rounded-2xl border border-[var(--color-border)] bg-[rgba(17,17,17,0.5)] p-8">
              <div className="mb-6">
                <span className="rounded-lg bg-[rgba(0,200,83,0.1)] px-3 py-1 font-[family-name:var(--font-mono)] text-xs font-bold text-[var(--color-accent-green)]">MIT</span>
              </div>
          ...
          <ScrollReveal delay={100}>
            <div className="relative flex h-full flex-col rounded-2xl border-2 border-[var(--color-accent-amber)] bg-[rgba(255,107,0,0.03)] p-8 shadow-[0_0_40px_rgba(255,107,0,0.08)]">
              ...
              <div className="mb-6">
                <span className="rounded-lg bg-[rgba(255,107,0,0.1)] px-3 py-1 font-[family-name:var(--font-mono)] text-xs font-bold text-[var(--color-accent-amber)]">CLOUD</span>
              </div>
          ...
          <ScrollReveal delay={200}>
            <div className="card-glow flex h-full flex-col rounded-2xl border border-[var(--color-border)] bg-[rgba(17,17,17,0.5)] p-8">
              <div className="mb-6">
                <span className="rounded-lg bg-[rgba(155,109,255,0.1)] px-3 py-1 font-[family-name:var(--font-mono)] text-xs font-bold text-[var(--color-accent-purple)]">ENTERPRISE</span>
              </div>
  ...
  return (
    <section className="border-t border-[var(--color-border)] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-widest text-[var(--color-accent-amber)]">Open Source</p>
        ...
        <div className="mx-auto grid max-w-4xl gap-5 md:grid-cols-3">
          ...
          <ScrollReveal delay={160}>
            <div className="card-glow h-full rounded-xl border border-[var(--color-border)] bg-[rgba(17,17,17,0.5)] p-6">
              ...
              <h3 className="mb-2 text-[15px] font-semibold text-[oklch(0.9_0_0)]">Verify Everything</h3>
              <p className="text-sm leading-relaxed text-[oklch(0.5_0_0)]">
  ...
  return (
    <section id="faq" className="border-t border-[var(--color-border)] py-24">
      <div className="mx-auto max-w-6xl px-6">
        <ScrollReveal>
          <div className="mb-16 text-center">
            <p className="mb-3 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-widest text-[var(--color-accent-amber)]">FAQ</p>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[rgba(255,107,0,0.15)] bg-[rgba(255,107,0,0.03)] px-8 py-16 text-center md:px-16">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mb-8 max-w-xl text-base leading-relaxed text-[oklch(0.5_0_0)]">
                LoopStorm Guard is open source, free, and installs in under a minute.
                No account required. No network dependency. Just safety.
              </p>
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mb-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="mb-4 flex items-center gap-1.5">
              ...
              <span className="font-[family-name:var(--font-mono)] text-xs font-semibold text-[var(--color-accent-amber)]">Guard</span>
            </div>
            <p className="text-sm leading-relaxed text-[oklch(0.4_0_0)]">
              Runtime guardrails for AI agents. Open source. Fail-closed. No AI in the critical path.
            </p>
          </div>

          {/* Product */}
          <div>
            <h4 className="mb-4 font-[family-name:var(--font-mono)] text-xs font-semibold uppercase tracking-wider text-[oklch(0.5_0_0)]">Product</h4>
            <ul className="flex flex-col gap-2.5">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-sm text-[oklch(0.4_0_0)] no-underline transition-colors duration-300 hover:text-white">{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Resources */}
          <div>
            <h4 className="mb-4 font-[family-name:var(--font-mono)] text-xs font-semibold uppercase tracking-wider text-[oklch(0.5_0_0)]">Resources</h4>
            <ul className="flex flex-col gap-2.5">
              {[
                { label: "Documentation", href: "https://github.com/LoopStorm-Guard/loopstorm-guard/tree/main/docs" },
                { label: "GitHub", href: "https://github.com/LoopStorm-Guard/loopstorm-guard" },
                { label: "Security", href: "https://github.com/LoopStorm-Guard/loopstorm-guard/blob/main/SECURITY.md" },
                { label: "Changelog", href: "https://github.com/LoopStorm-Guard/loopstorm-guard/releases" },
              ].map((link) => (
                <li key={link.label}>
                  <a href={link.href} target={link.href.startsWith("http") ? "_blank" : undefined} rel={link.href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-sm text-[oklch(0.4_0_0)] no-underline transition-colors duration-300 hover:text-white">{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Company */}
          <div>
            <h4 className="mb-4 font-[family-name:var(--font-mono)] text-xs font-semibold uppercase tracking-wider text-[oklch(0.5_0_0)]">Company</h4>
            <ul className="flex flex-col gap-2.5">
              {[
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-[var(--color-border)] pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            <span className="rounded-md bg-[rgba(0,200,83,0.1)] px-2 py-0.5 font-[family-name:var(--font-mono)] text-[10px] font-semibold text-[var(--color-accent-green)]">MIT</span>
            <span className="text-[10px] text-[oklch(0.3_0_0)]">Engine + CLI + Shims</span>
            <span className="rounded-md bg-[rgba(155,109,255,0.1)] px-2 py-0.5 font-[family-name:var(--font-mono)] text-[10px] font-semibold text-[var(--color-accent-purple)]">AGPL-3.0</span>
